  ...
  navbarPage("Visualización avanzada - UNED máster Big Data",
             tabPanel("Descripción del trabajo",
                      mainPanel(
                        ...
                        h3("Conjunto de graficas disponibles sobre datos previamente descargados para funcionamiento OFFLINE:", 
                           align = "left"),
                        p(""),
                        ...
                        h4("* La distribución de las fuentes de producción de energía electrica, según los ultimos datos disponibles y datos de ayer"),
                        p(""),
